...
name = random.choice(['Дарья', 'Ирина', 'Елена'])
family_name = random.choice(['Иванова', 'Петрова', 'Сидорова'])
address = random.choice(['г. Москва, ул. Цветной Бульвар, д.1', 'г. Москва, ул. Цветной Бульвар, д.2', 'г. Москва, ул. Цветной Бульвар, д.3'])
metro = 'Бульвар Рокоссовского'
phone = random.choice(['89877856585', '+79875896325', '89179856958'])
when = '25.04.2024'
comment = random.choice(['Привезти заранее', 'Комментарий 1'])
